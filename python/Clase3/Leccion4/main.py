...
# Metodos de ordenamiento, en python es una función
...
seleccionArgentina = {
    ...
    1: {"Nombre": "Franco Armani", "Edad": 35, "Altura": 1.89, "Precio": "3.5 Millones", "Posicion": "Defensa Central"}
}

for llave, valor in seleccionArgentina.items():
    print(llave, valor)

# Como tarea agregar por lo menos 4 jugadores mas al diccionario: seleccionArgentina (Tarea realizada en la carpeta Tarea que se encuentra dentro de la carpeta Python)
